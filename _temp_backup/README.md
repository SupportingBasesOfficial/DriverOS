...
> Monorepo Turborepo + Next.js 15 + Expo + Supabase + TypeScript.  
> Plataforma completa de gestão para motoristas de aplicativo.

![Supabase Deploy](https://github.com/SupportingBasesOfficial/DriverOS/actions/workflows/supabase-deploy.yml/badge.svg)
...
| **Web**      | Next.js 15.3                      | Painel administrativo                         |
| **Mobile**   | Expo SDK 52 + React Native        | App do motorista (GPS, TTS, offline)          |
| **UI Web**   | shadcn/ui + Tailwind v3           | Design system                                 |
| **UI Mobile**| NativeWind                        | Tailwind no React Native                      |
| **Data**     | Supabase                          | PostgreSQL + Auth + Storage + Realtime        |
| **Maps**     | MapLibre + OpenStreetMap          | Mapas gratuitos e offline                     |
| **Types**    | TypeScript 5.9                    | Tipagem end-to-end                            |
...
# 4. Aplique migrations e sincronize tipos (AUTOMATIZADO)
# Opcao A: Script completo (instala CLI, faz login, aplica migrations, gera tipos)
pnpm db:setup

# Opcao B: Comandos individuais (se ja tiver o Supabase CLI instalado)
npx supabase login
npx supabase link --project-ref wobazrdzckzaoununlje
npx supabase db push
pnpm db:types

# Opcao C: Reset local (requer Docker)
npx supabase db reset

# 5. Desenvolva
pnpm dev          # http://localhost:3000

# 6. Gerar APK do app mobile (EAS Build)
pnpm build:apk     # Ou: cd apps/mobile && eas build --profile preview
# Acompanhe em: https://expo.dev/accounts/supportingbasesofficial/projects/driveros
```
